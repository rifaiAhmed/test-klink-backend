...
type Member struct {
	...
	JenisKelamin   string `json:"jenis_kelamin" gorm:"type:varchar(50);not null" validate:"required"`
	...
	TanggalLahir   string `json:"tanggal_lahir" gorm:"type:varchar(50);not null" validate:"required"`
	NoHp           string `json:"no_hp" gorm:"type:varchar(50);"`
	Email          string `json:"email" gorm:"type:varchar(50);"`
	NoRekening     string `json:"no_rekening" gorm:"type:varchar(50);"`
	UplineMemberID string `json:"up_line_member_id" gorm:"type:varchar(50);"`
